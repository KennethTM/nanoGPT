...
#https://github.com/pytorch-labs/gpt-fast/issues/108
...
def quantize_int8(checkpoint_path: str) -> None:
    ...
    quantize_path = checkpoint_path.replace('.pth', '-int8.pth')
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Quantize GPT model to int8")
    parser.add_argument(
        "--checkpoint_path",
        type=str,
        required=True,
        help="Path to the checkpoint to quantize",
    )

    args = parser.parse_args()

    quantize_int8(args.checkpoint_path)